    ...
    public static void SendMail(String recepient) throws Exception {
     ...
     private static Message prepareMessage(Session session, String myAccountEmail, String recepient) {
        try {
            ...
            message.setSubject("Important Notice from Library: REJECTED BOOK REQUEST");
            message.setText("Good Day. \n \nWe are sorry to inform you that the book that you're trying to borrow was Rejected. \nPlease try again in another days  \n \n \n____________________________________________________ \nIf you have any questions, concerns, or recommendations, dont hesitate to contact us through: \nEmail: group1.librarysystem@gmail.com \nor Call Us: 8123 4567");
            return message;
        } catch (Exception ex) {
            Logger.getLogger(RejectedMail.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
}
